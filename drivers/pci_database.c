...
static const pci_dev_t vga_devices[] = {
    ...
    {
        PCI_VENDOR_ID_ATI, PCI_DEVICE_ID_ATI_RADEON_9800,
    ...
    {
        PCI_VENDOR_ID_NVIDIA, 0x0200,
        NULL, "NVIDIA",      "GeForce3", "VGA\0",
        0, 0, 0,
        NULL, NULL,
    },
    {
        PCI_VENDOR_ID_NVIDIA, 0x02e1,
        NULL, "NVIDIA",      "GeForce 7600 GS", "VGA\0",
        0, 0, 0,
        NULL, NULL,
    },
    {
        PCI_VENDOR_ID_NVIDIA, 0x0221,
        NULL, "NVIDIA",      "GeForce 6200", "VGA\0",
        0, 0, 0,
        NULL, NULL,
    },
    {
        PCI_VENDOR_ID_NVIDIA, 0x0326,
        NULL, "NVIDIA",      "GeForce FX 5500", "VGA\0",
        0, 0, 0,
        NULL, NULL,
    },
    {
